...
$$
\boxed{(1)\ 120\ \text{V}, \quad (2)\ 300\ \text{V}, \quad (3)\ 120\ \text{V}}
$$
...
2.1-8%半径为$R_1$的导体球带有电荷 $q$,球外有一个内,外半径为$R_2,R_3$ 的同心导体球壳,壳上带有电荷 $Q$
...
内球:电荷 $ q $ 均匀分布在 $ r = R_1 $ 表面。  

外球壳内表面($ r = R_2 $):由于内球带 $ q $,静电感应使外球壳内表面带 $ -q $

外球壳外表面($ r = R_3 $):外球壳总电荷 $ Q $,所以外表面带 $ Q + q $。
...
(b) 内球的电势 $ U_1 $
从 $ r = R_1 $ 到 $ R_2 $ 有电场 $ \frac{q}{4\pi\varepsilon_0 r^2} $,

从 $ R_2 $ 到 $ R_3 $ 电场为 0,从 $ R_3 $ 到无穷远有 $ \frac{Q+q}{4\pi\varepsilon_0 r^2} $:

$$U_1 = \int_{R_1}^{R_2} \frac{q}{4\pi\varepsilon_0 r^2}dr+ 0 + \int_{R_3}^{\infty} \frac{Q+q}{4\pi\varepsilon_0 r^2} dr= \frac{1}{4\pi\varepsilon_0} \left[ \frac{q}{R_1} - \frac{q}{R_2} + \frac{Q+q}{R_3} \right]$$



$$\boxed{U_1 = \frac{1}{4\pi\varepsilon_0} \left( \frac{q}{R_1} - \frac{q}{R_2} + \frac{Q+q}{R_3} \right),U_2 = \frac{Q+q}{4\pi\varepsilon_0 R_3}}$$


\vspace{2em}
(2):两球电势差
$$\Delta U = U_1 - U_2= \frac{1}{4\pi\varepsilon_0} \left[ \frac{q}{R_1} - \frac{q}{R_2} + \frac{Q+q}{R_3} - \frac{Q+q}{R_3} \right]$$
...
连接后,内球与外球壳等势,电荷重新分布,静电平衡时导体内部无电荷
 
初始:内球 $ q $,外球壳 $ Q $,总电荷 $ q+Q $ 

连接后,内球与外球壳导体连通成为一个导体

电荷全部分布在外表面($ r = R_3 $),电荷为 $ q+Q $

内球表面电荷为 0,外球壳内表面($ r=R_2 $)电荷也为 0,
...
$$U_1 = \int_{R_1}^{R_2} \frac{q}{4\pi\varepsilon_0 r^2} dr + 0 + 0= \frac{q}{4\pi\varepsilon_0} \left( \frac{1}{R_1} - \frac{1}{R_2} \right).$$
$$U_2 = 0.$$
...
$$q' = -\frac{Q/R_3}{\frac{1}{R_1} - \frac{1}{R_2} + \frac{1}{R_3}}=-\frac{QR_1R_2}{R_2R_3-R_1R_3+R_1R_2}$$

$$U_2 = \frac{Q + q'}{4\pi\varepsilon_0 R_3}=\frac{Q(R_2-R_1)}{4\pi\varepsilon_0(R_2R_3-R_3R_1+R_1R_2)}$$


$$\boxed{ U_1 = 0, \quad , U_{2}=\frac{Q(R_{2}-R_{1})}{4\pi\varepsilon_{0}(R_{2}R_{3}-R_{3}R_{1}+R_{1}R_{2})}}$$
$$\boxed{\Delta U=-U_{2}=\frac{Q(R_{1}-R_{2})}{4\pi\varepsilon_{0}(R_{2}R_{3}-R_{3}R_{1}+R_{1}R_{2})}}$$
...
设内圆柱带电线电荷密度为 $ +\lambda $,外圆柱内表面感应 $ -\lambda $

由高斯定理,对于长度为 $ L $、半径为 $ r $($ R_1 < r < R_2 $)的同轴圆柱面
...
内、外圆柱间电压:
$$U_1 - U_2 = \int_{R_1}^{R_2} E(r)  dr= \int_{R_1}^{R_2} \frac{\lambda}{2\pi\varepsilon_0 r}  dr= \frac{\lambda}{2\pi\varepsilon_0} \ln\frac{R_2}{R_1}.$$
...
$$U(r) = U_1 - \int_{R_1}^{r} E(r')  dr'= U_1 - \frac{\lambda}{2\pi\varepsilon_0} \int_{R_1}^{r} \frac{dr'}{r'}= U_1 - \frac{\lambda}{2\pi\varepsilon_0} \ln\frac{r}{R_1}.$$

代入 $\lambda$:

$$U(r) = U_1 - \frac{U_1 - U_2}{\ln(R_2/R_1)} \cdot \ln\frac{r}{R_1}= U_1-(U_1-U_2)\frac{\ln(\frac{r}{R_1})}{\ln(\frac{R_2}{R_1})}.$$

$$
\boxed{U(r) =U_1-(U_1-U_2)\frac{\ln(\frac{r}{R_1})}{\ln(\frac{R_2}{R_1})}, \quad R_1 < r < R_2}
$$
